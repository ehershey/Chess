...
// Aliases
    ...
    WHITE_KNIGHT = PIECE_KNIGHT + (0 * PIECE_COLOR_OFFSET),
    WHITE_BISHOP = PIECE_BISHOP + (0 * PIECE_COLOR_OFFSET),
    WHITE_QUEEN  = PIECE_QUEEN  + (0 * PIECE_COLOR_OFFSET),
    WHITE_KING   = PIECE_KING   + (0 * PIECE_COLOR_OFFSET),
    WHITE_EMPTY  = PIECE_EMPTY  + (0 * PIECE_COLOR_OFFSET),

    BLACK_PAWN   = PIECE_PAWN   + (1 * PIECE_COLOR_OFFSET),
    BLACK_ROOK   = PIECE_ROOK   + (1 * PIECE_COLOR_OFFSET),
    BLACK_KNIGHT = PIECE_KNIGHT + (1 * PIECE_COLOR_OFFSET),
    BLACK_BISHOP = PIECE_BISHOP + (1 * PIECE_COLOR_OFFSET),
    BLACK_QUEEN  = PIECE_QUEEN  + (1 * PIECE_COLOR_OFFSET),
    BLACK_KING   = PIECE_KING   + (1 * PIECE_COLOR_OFFSET),
    BLACK_EMPTY  = PIECE_EMPTY  + (1 * PIECE_COLOR_OFFSET),
